...
encryption~\cite{xxx}\tsnote{BBO}, searchable
encryption~\cite{xxx}\tsnote{Highly-scalable searchable symmetric
  encryption with support for boolean queries, Crypto'13} and
...
as recent attacks show~\cite{...}\tsnote{Leakage-Abuse Attacks against
  searchable encryption, CCS'15; Leakage-Abuse Attacks against
  order-revealing encryption, S and P '17; Inference Attacks on
  Property Preserving Encryption, CCS'15}, capturing what is leaked
...
develop database encryption schemes~\cite{xxx}\tsnote{Why your
  Encrypted Database is not secure, HotOS'17}. 
