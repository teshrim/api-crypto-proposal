...
software libraries, specifically the APIs they export, is hard work; and that
once fielded, APIs cannot simply be changed to accomodate the latest
theory.  
...
\begin{itemize}
  \item Theory is considerably more useful to \textit{real-world security}
    when it is mindful of how it  are translated into practice.
...
\todo{Summarize body section, focusing on tasks and (very briefly)
  prior work by me.}
\tsnote{subsume implemenation-considerate formalisms into this.}
\todo{Summarize body section, focusing on tasks and (very briefly)
  prior work by me.}
