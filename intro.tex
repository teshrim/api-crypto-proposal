...
practice-grounded view of the security of primtives.  All of the
research that we propose here adheres to an agenda of API-centric cryptography.
...
cryptographers and security researchers, we will produce higher-levels
...
research systems (e.g. LibFTE, Marionette \todo{Chris, can you please
  grab the github urls for these?  They will be owned by Kevin Dyer or
  Scott Coull}), 
...
cryptography that is relevant to practice and forgiving of misuse (e.g.,\cite{RS06,rfc5297,BRSS10,PRS11,luchaup2014libfte,ST15}), of
