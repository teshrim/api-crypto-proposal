...
\todo{Chris: Is there a real task here?  I thought there was... Is
  there a way to better incorporate this/position this/write this? I
  like the idea of having a couple of tasks per (sub)section.  }
\begin{task}
