...
changing.
%
\todo{Chris: Give an example that motivates the analysis of TLS 1.3.}
%
...
\noindent
\todo{Tom: Review this task below. This is something I'm doing as part of the
TLS project, and I realize it might be interesting to mention here.}
...
message and error outputs. We are unaware of any work \cpnote{Not even
\url{https://ia.cr/2013/433}} that explicitly treat this separation.
%
