...
security provided by the underlying crypto.\todo{Chris: example citations?}. This gap has spurred the study of
...
of the TLS $1.2$ record layer by PI Shrimpton~\cite{PRS11}. Boldyreva
