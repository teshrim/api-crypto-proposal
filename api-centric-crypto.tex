...
to specify the per-encryption randomness.  

Other constructions of hedged PKE that do not explicit require the
...
\begin{task}
  We will consider constructions similar in spirit to prior work
