...
\newcommand{\notetoms}[1]{\note{TomS}{\bf\textcolor{blue}{#1}}}
\newcommand{\tsnote}{\notetoms} 
\newcommand{\notetomr}[1]{\note{TomR}{#1}}
\newcommand{\tnote}[1]{\ifnum\authnotes=1\refstepcounter{mynote}{\bf\textcolor{cyan}{$\ll$TCR~\thenote: {\sf #1}$\gg$}}\fi}
\newcommand{\noteari}[1]{\note{Ari}{#1}}
...
\newcommand{\mytitle}{TWC: Medium: Collaborative:\\
  \smallskip Distribution-Sensitive Cryptography} 
...
\medskip
\noindent\textbf{Principal Investigator:} Ari Juels (Cornell Tech)\\
\noindent\textbf{Principal Investigator:} Thomas Ristenpart
(University of Wisconsin)\\
\noindent\textbf{Principal Investigator:} Thomas Shrimpton (Portland State University)\\
...
%%%-- DPI-circumvention and DME  ------------------------------
\input{DSE}

%%%-- Securing human-generated secrets ------------------------------
\input{pwstego}
...
%%%-- Transition to Practic plan (if we want to go this route) ------------------------------
%\clearpage
%\renewcommand{\thepage}{M-\arabic{page}}
%\setcounter{page}{1}
