...
counters, lists of nonces already observed on the channel,\cpnote{More likely it
...
specified to keep a strike-list of observed nonces.}  information about the
